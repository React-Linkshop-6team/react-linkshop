export const mockData = {
  ...
  list: [
    ...
    },
    {
      ...
      likes: 12,
      shop: {
        imageUrl: 'https://example.com/shop4.png',
        urlName: 'luxury-dog',
        shopUrl: 'https://example.com/luxury-dog',
        id: 4,
      },
      productsCount: 2,
      products: [
        {
          id: 401,
          name: '프리미엄 간식',
          imageUrl: 'https://example.com/product7.png',
        },
        {
          id: 402,
          name: '강아지 패딩',
          imageUrl: 'https://example.com/product8.png',
        },
      ],
      teamId: 'team456',
      updatedAt: '2025-04-15T04:35:16.229Z',
    ...
    },
    {
      ...
      likes: 18,
      shop: {
        imageUrl: 'https://example.com/shop5.png',
        urlName: 'cats-house',
        shopUrl: 'https://example.com/cats-house',
        id: 5,
      },
      productsCount: 2,
      products: [
        {
          id: 501,
          name: '고양이 스크래쳐',
          imageUrl: 'https://example.com/product9.png',
        },
        {
          id: 502,
          name: '고양이 해먹',
          imageUrl: 'https://example.com/product10.png',
        },
      ],
      teamId: 'team123',
      updatedAt: '2025-04-15T04:35:16.229Z',
    ...
    },
    {
      ...
      likes: 7,
      shop: {
        imageUrl: 'https://example.com/shop6.png',
        urlName: 'pastel-pet',
        shopUrl: 'https://example.com/pastel-pet',
        id: 6,
      },
      productsCount: 1,
      products: [
        {
          id: 601,
          name: '알록달록 방석',
          imageUrl: 'https://example.com/product11.png',
        },
      ],
      teamId: 'team789',
      updatedAt: '2025-04-15T04:35:16.229Z',
